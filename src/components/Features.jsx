        ...
        <div className='flex flex-col justify-center items-center overflow-hidden'>
          ...
          <div className='flex-center flex-col sm:px-10'>
            <div className='relative h-[50vh] w-full felx items-center'>
              <video playsInline muted autoPlay id='explore-video' className='w-full h-full object-cover object-center' preload='none' ref={videoRef}>
            ...
            <div className='flex flex-col w-full relative'>
              <div className='feature-video-container'>
                ...
                <div className='overflow-hidden flex-1 h-[50vh]'>
                  <img src={explore2Img} alt='titanuim2' className='feature-video g_grow'/> 
                </div>
              </div>
